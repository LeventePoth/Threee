...
public class UserServiceImpl implements UserService {
  ...
  private com.threee.User.UserRepository userRepository;

  @Autowired
  public UserServiceImpl(com.threee.User.UserRepository userRepository) {
  ...
  @Override
  public Users restRegister(String confirm, com.threee.User.UserDTO userDTO) {
