...
@Service
public class MailgunServiceImpl implements com.threee.User.MailgunService {
  ...
  @Override
  public ClientResponse sendSimpleMessage(com.threee.User.Users users) {
  ...
  public ClientResponse sendComplexMessage(com.threee.User.Users users) {
    Client client = Client.create();
    String recipient = users.getEmail();
    client.addFilter(new HTTPBasicAuthFilter("api", mailgunApiKey));
    WebResource webResource = client.resource("https://api.mailgun.net/v3/" + mailgunDomainName
